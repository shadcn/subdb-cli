  ...
  exports.getHash(file_path, function (hash) {
    if (hash) {
      ...
      exports.call(options, function(error, response, body) {
        ...
        var fileEncoding = detectCharacterEncoding(body).encoding;

        // If detected encoding is not utf8 we have to convert it
        if (fileEncoding !== 'UTF-8') body = iconv.decode(body, fileEncoding);
